use sigma_rs::aggregation::{AggregationFunction, AggregationEvaluator, AggregationConfig, SlidingWindow};
use sigma_rs::ast::nodes::{NodeAggregation, ComparisonOp};
...
async fn test_ttl_cleanup() {
    let evaluator = AggregationEvaluator::with_config(
        AggregationConfig {
